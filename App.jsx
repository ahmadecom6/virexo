  ...
  return (
    ...
    <div className="site-shell">
      <header className={`nav-wrap${menuOpen ? ' menu-open' : ''}`}>
        ...
        <div className="nav-actions"><a className="nav-cta" href="#contact">Start a project <span aria-hidden="true">-&gt;</span></a><button className="theme-toggle" type="button" aria-label={darkMode ? 'Switch to light mode' : 'Switch to dark mode'} aria-pressed={darkMode} onClick={() => setDarkMode((mode) => !mode)}><span aria-hidden="true">{darkMode ? '☀' : '☾'}</span></button></div>
